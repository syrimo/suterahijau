  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-charcoal">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center pointer-events-none">
        <h1 className="sr-only">Sutera Hijau Academy Sdn. Bhd. — We build quietly. We ship real things.</h1>
        <img
          src="/logo-white.png"
          alt="Sutera Hijau Academy Sdn. Bhd."
          className="mb-6 h-14 opacity-90 drop-shadow-lg md:h-18 lg:h-20"
        />
        <p className="mt-2 text-center text-sm tracking-[0.3em] text-white/60 uppercase md:text-base" aria-label="Tagline">
          We build quietly. We ship real things.
        </p>
